...
export const campaignEscrowAbi = [
  ...
  },
  {
    ...
    "outputs": [
      ...
      },
      {
        "name": "status",
        "type": "uint8",
        "internalType": "enum CampaignEscrow.PlacementStatus"
      },
      {
        "name": "evidenceHash",
        "type": "bytes32",
  ...
  {
    "type": "error",
    "name": "UnfundedCampaign",
    "inputs": []
  },
  {
    "type": "error",
    "name": "WorkersUnassigned",
    "inputs": []
  },
  {
    "type": "error",
